...
GameOverPanel; (function(b) {
    ...
    var c = function(c) {
        ...
        k.prototype.update = function(a, b, d) {
            ...
            this), this.addChild(this.nextBtn)) : (this.badge.texture = RES.getRes("badge-text"), this.badgeEffect.texture = RES.getRes(""), this.addChild(this.replayBtn), this.addChild(this.moreBtn));
            this.currentScore = a
        };
